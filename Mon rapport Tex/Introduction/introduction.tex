...
=======
Dans le cadre de la thèse de Mme Morgane Mignot \alert{(ref ou footnote à voir)}, le développement d'un outil logiciel qui vise à faciliter la mise en place d'un modèle numérique basé sur CROCO et l'exploiter des résultats, a débuté: QCrocoFlow. Ce dernier est intégré en tant que plugin dans le logiciel de Système d'Information Géographique (SIG) QGIS \cite{QGIS}. L'objectif de mon stage est de développer les procédures de mise en place des conditions initiales nécessaires au démarrage d'un modèle CROCO.
