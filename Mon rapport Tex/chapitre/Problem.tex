...
\begin{figure}[H]
	...
	\caption[Mailles]{Figure 2 : Schéma illustrant une maille individuelle de la grille de modélisation. Les composantes de vitesse, u et v, sont représentées aux coins de la maille, tandis que les variables scalaires, telles que la température, la salinité et la vitesse du courant, sont localisées au centre de la maille.\textit{ Source: Researchgate.}}
	\label{fig:mailles}
\end{figure}
\vspace{1cm}
