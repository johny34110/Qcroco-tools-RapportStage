...
Au-delà de la simple collecte d'informations, cette phase a été cruciale pour la modélisation des données. Ce que mon maître de stage appelle la partie "brainware", c'est-à-dire la compréhension logique de l'organisation de l'information. C'est ici que j'ai conceptualisé comment les différentes pièces du puzzle s'emboîtent, comment les données s'interconnectent et comment elles doivent être structurées pour une utilisation optimale dans le modèle CROCO.
